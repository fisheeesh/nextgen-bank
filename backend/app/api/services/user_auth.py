...
from ...core.services.login_otp import send_login_otp_email
...
class UserAuthService:
    ...
    async def verity_user_password(
        self,
        plain_password: str,
        hashed_password: str,
    ) -> bool:
        ...
        try:
            ...
            for attempt in range(3):
                try:
                    ...
                    logger.info(f"OTP send to {user.email} successfully")
                    return True, otp
                    ...
                    # ! Exponential backoff is a technique used to reduct the frequency of requests to a server by increasing the delay between each request
    ...
    async def check_user_lockout(
        ...
        lockout_time = user.last_failed_login + timedelta(
            minutes=settings.LOGOUT_DURATION_MINUTES
        )
        ...
        raise HTTPException(
            ...
            detail={
                ...
                "lockedout_remaining_minutes": remaining_minutes,
            },
        )
