...
from ....transactions.schema import (
    ...
    TransactionFilterParmasSchema,
    TransactionHistoryResponseSchema,
)
from ...routes.auth.deps import CurrentUser, SessionDep
from ...services.transaction import get_user_transactions
...
@router.get(
    ...
    description="Get paginated transaction history for the authenticatd user",
)
async def get_transaction_history(
    ...
    filters: TransactionFilterParmasSchema = Depends(),
) -> PaginatedTransactionResponseSchema:
    try:
        if (
            filters.start_date
