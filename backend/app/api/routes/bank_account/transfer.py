...
from ...services.transaction import complete_transfer, initiate_transfer
from ....core.logging import get_logger
from ....core.services.transfer_alert import send_transfer_alert
from ....core.services.transfer_otp import send_transfer_otp_email
...
async def initiate_money_transfer(
    ...
    try:
        ...
        if not idempotency_key:
            raise HTTPException(
                status_code=status.HTTP_400_BAD_REQUEST,
                detail={"status": "error", "message": "Idempotency-Key is required"},
            )
