...
from ....user_profile.schema import ProfileResponseSchema
from ...services.profile import get_user_with_profile
...
async def get_my_profile(
    ...
    try:
        ...
        logger.debug(f"Successfully fetch profile for user {user_with_profile.id}")
        return response
