...
from ...core.emails.base import EmailTemplate
...
async def send_account_lock_email(email: str, lockout_time: datetime) -> None:
    unlock_time = lockout_time + timedelta(minutes=settings.LOGOUT_DURATION_MINUTES)

    context = {
        "lockout_duration": settings.LOGOUT_DURATION_MINUTES,
