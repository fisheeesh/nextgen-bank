...
class SecurityQuestionsSchema(str, Enum):
    ...
    # $ @classmethod allows us to define a method that is bound to the class and not the instance
    @classmethod
...
class UserCreateSchema(BaseUserSchema):
    ...
    # ? allows us to validate data before it is saved to the database
    @field_validator("confirm_password")
    # ? cls -> class itself, v -> value of confirm_password, values -> dict of values of all the other fields in the class
...
# ? ... means required
# ? v means validate - values being validated
# ? values is dict of all the field values
