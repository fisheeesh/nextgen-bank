...
def upgrade() -> None:
    ...
    sa.Column('title', sa.Enum('Mr', 'Mrs', 'Miss', name='salutaionschema'), nullable=False),
    ...
    sa.Column('means_of_identification', sa.Enum('Passport', 'Divers_License', 'Natinal_ID', name='identificationtypeschema'), nullable=False),
    ...
    sa.Column('employement_status', sa.Enum('Employed', 'Unemployed', 'Self_Employed', 'Student', 'Retired', name='employmentstatusschema'), nullable=False),
