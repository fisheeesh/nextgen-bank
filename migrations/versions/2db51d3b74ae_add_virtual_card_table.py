...
Revision ID: 2db51d3b74ae
Revises: b4d3a6f0c8a1
Create Date: 2026-06-27 07:24:36.033627
...
revision: str = '2db51d3b74ae'
down_revision: Union[str, None] = 'b4d3a6f0c8a1'
...
def upgrade() -> None:
    ...
    sa.Column('last_top_up_date', postgresql.TIMESTAMP(timezone=True), nullable=False, sever_default=sa.text('CURRENT_TIMESTAMP')),
    sa.Column('blocked_at', postgresql.TIMESTAMP(timezone=True), nullable=False, sever_default=sa.text('CURRENT_TIMESTAMP')),
    ...
    sa.Column('delivery_card_status', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
