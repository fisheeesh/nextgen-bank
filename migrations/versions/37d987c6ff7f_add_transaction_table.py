...
def upgrade() -> None:
    ...
    sa.Column('transaction_type', sa.Enum('Deposit', 'Withdrawal', 'Transfer', 'Reversal', 'Fee_Charged', 'Loan_Disbursement', 'Load_Repayment', 'Interest_Credited', name='transactiontypeenum'), nullable=False),
    ...
    sa.Column('create_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
